...
from utils.functions import (sampling_strategy_wu2019, create_binary_labels_column, map_feat_id_func, tokenize_seq, impute_list_with_mean, encode_date_list,
...
del train_news, test_news, test2_news
gc.collect()
...
del history, train_behaviors, valid_behaviors
gc.collect()
