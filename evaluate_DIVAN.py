...
if __name__ == '__main__':
    ...
    logging.info('DIVAN metrics')
    valid_result = model.evaluate_test(valid_gen)
    logging.info('DIN metrics')
    valid_din_result = model.evaluate_din(valid_gen)
    logging.info('Virality-aware Click Predictor metrics')
    valid_vir_result = model.evaluate_vir(valid_gen)
    del valid_gen
    gc.collect()
