...
# Behaviours Large
df_behaviours = pl.scan_parquet("../data/Ebnerd_large/validation/behaviors.parquet")
...
df_history = pl.scan_parquet("../data/Ebnerd_large/validation/history.parquet").filter(pl.col("user_id").is_in(unique_user_id))
...
# Filtriamo articles
df_articles = pl.scan_parquet("../data/Ebnerd_large/train/articles.parquet").filter(pl.col("article_id").is_in(article_id))
# SALVATAGGIO FILE
os.makedirs("../data/Ebnerd_demo/test2", exist_ok=True)
df_articles.collect().write_parquet("../data/Ebnerd_demo/test2/articles.parquet")
sample.write_parquet("../data/Ebnerd_demo/test2/behaviors.parquet")
df_history.collect().write_parquet("../data/Ebnerd_demo/test2/history.parquet")
